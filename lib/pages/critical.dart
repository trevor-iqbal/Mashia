...
class _CriticalState extends State<Critical> {
  ...
  void _showSuccessSnack() {
      final snackbar = SnackBar(
          content: Text('Profile successfully loaded!',
                  ...
                  return Center(
                    child: ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int position){
                        ...
                        return Column(
                          children: <Widget>[
                            int.parse('${cows[position]['reading'][position]['pulserate']}') > 80?
                            Card(
                              child: Row(
                                ...
                                children: <Widget>[
                                  ...
                                  SizedBox(
                                    child: Card(
                                      color: int.parse('${cows[position]['reading'][position]['pulserate']}') > 80? Colors.red: Colors.green,
                                      child: Row(
                                        children: <Widget>[
                                          Padding(
                                            padding: const EdgeInsets.all(8.0),
                                            child: Image.asset(int.parse('${cows[position]['reading'][position]['pulserate']}') > 80? 'assets/up.png': 'assets/down.png', color: Colors.black,fit: BoxFit.contain,),
                                          ),
                                          Column(
                                            children: <Widget>[
