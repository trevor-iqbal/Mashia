                                    ...
                                    Card(
                                      child: Row(
                                        ...
                                        children: <Widget>[
                                          ...
                                          SizedBox(
                                            child: Card(
                                              color: double.parse('${cows[position]['reading'][position]['temperature']}') > 38? Colors.orange: Colors.yellow,
                                              child: Row(
                                                children: <Widget>[
                                                  Padding(
                                                    padding: const EdgeInsets.all(8.0),
                                                    child: Image.asset(double.parse('${cows[position]['reading'][position]['pulserate']}') > 80? 'assets/up.png': 'assets/health.png', color: Colors.white,fit: BoxFit.contain,),
                                                  ),
                                                  Column(
                                                    children: <Widget>[
